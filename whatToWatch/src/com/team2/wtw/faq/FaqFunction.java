...
public class FaqFunction {
	...
	public void showSolution(String input) {
		...
		case "4":
			...
			System.out
					.println("불법프로그램을 사용하여 이벤트에 참여한 경우 점수가 갱신되지 않습니다. 해당 문제가 발생한 경우 고객센터 02-123-4567 로 자세한 문의 바랍니다.\n");
			goodBad();
			break;
		case "5":
			System.out.println("이벤트 참여 후 상품지급에 대해 문의할 경우 >>");
			System.out.println(
					"상품 지급은 이벤트 점수 확인 후 주말(공휴일 포함)제외 최대 일주일 정도 소요됩니다. 일정 기간이 지난 후 상품지급이 되지 않았을 경우 고객센터 문의 바랍니다.\n");
			goodBad();
			break;
		case "6":
			...
			break;
		default:
			System.out.println("문의 번호를 다시 확인해 주세요.");
		}
	}
